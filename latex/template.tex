%fix pandoc 2.11 update: https://github.com/jgm/pandoc/commit/82280cc62c9fdfe7ffe1b0d8443d1739b441e22b
$if(csl-refs)$
...
\includepdf[pages={1}, scale=1]{output/front_matter.pdf}
...
\includepdf[pages={2}, scale=1]{output/front_matter.pdf}
